...
our $services = {
  'apache' => {
    'uid' => $stuid,
    'gid' => $stgid,
    'start' => '/opt/spamtagger/etc/init.d/apache start',
    'stop' => '/opt/spamtagger/etc/init.d/apache stop',
    'files' => {
      'access.log' => [ '%d/%b/%Y' ],
  ...
  'clamav' => {
    'uid' => $cluid,
    'gid' => $clgid,
    'start' => '/opt/spamtagger/etc/init.d/clamd start && /opt/spamtagger/etc/init.d/clamspamd start',
    'stop' => '/opt/spamtagger/etc/init.d/clamd stop && /opt/spamtagger/etc/init.d/clamspamd stop',
    'files' => {
  ...
  'exim_stage1' => {
    'uid' => $stuid,
    'gid' => $stgid,
    'start' => '/opt/spamtagger/etc/init.d/exim_stage1 start',
    'stop' => '/opt/spamtagger/etc/init.d/exim_stage1 stop',
    'files' => {
      'mainlog' => [ '%Y-%m-%d' ],
      'paniclog' => [ '%Y-%m-%d' ],
      'rejectlog' => [ '%Y-%m-%d' ],
  ...
  'exim_stage2' => {
    'uid' => $stuid,
    'gid' => $stgid,
    'start' => '/opt/spamtagger/etc/init.d/exim_stage2 start',
    'stop' => '/opt/spamtagger/etc/init.d/exim_stage2 stop',
    'files' => {
      'mainlog' => [ '%Y-%m-%d' ],
      'paniclog' => [ '%Y-%m-%d' ],
      'rejectlog' => [ '%Y-%m-%d' ],
  ...
  'exim_stage4' => {
    'uid' => $stuid,
    'gid' => $stgid,
    'start' => '/opt/spamtagger/etc/init.d/exim_stage4 start',
    'stop' => '/opt/spamtagger/etc/init.d/exim_stage4 stop',
    'files' => {
      'mainlog' => [ '%Y-%m-%d' ],
      'paniclog' => [ '%Y-%m-%d' ],
      'rejectlog' => [ '%Y-%m-%d' ],
  ...
  'fail2ban' => {
    'uid' => 0,
    'gid' => 0,
    'start' => '/opt/spamtagger/etc/init.d/fail2ban start',
    'stop' => '/opt/spamtagger/etc/init.d/fail2ban stop',
    'files' => {
  ...
  'mailscanner' => {
    'uid' => $stuid,
    'gid' => $stgid,
    'start' => '/opt/spamtagger/etc/init.d/mailscanner start',
    'stop' => '/opt/spamtagger/etc/init.d/mailscanner stop',
    'files' => {
      'infolog' => [ '%b %d' ],
  ...
  'mariadb_source' => {
    'uid' => $myuid,
    'gid' => $stuid,
    'start' => '/opt/spamtagger/etc/init.d/mariadb_source start',
    'stop' => '/opt/spamtagger/etc/init.d/mariadb_source stop',
    'files' => {
      'mariadb.log' => [ '%y%m%d' ],
    },
  },
  'mariadb_replica' => {
    'uid' => $myuid,
    'gid' => $stuid,
    'start' => '/opt/spamtagger/etc/init.d/mariadb_replica start',
    'stop' => '/opt/spamtagger/etc/init.d/mariadb_replica stop',
    'files' => {
      'mariadb.log' => [ '%y%m%d' ],
    },
  }
...
sub fast_write ($logs, $service, $path, $suffix) {
...
than available memory.\n\n");
    ...
    usage();
  } elsif (defined($services->{$arg}) && !scalar(grep {/$arg/} @services_to_index)) {
