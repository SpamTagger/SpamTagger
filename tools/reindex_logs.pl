...
our $services = {
  ...
  'clamav' => {
    'uid' => $cluid,
    'gid' => $clgid,
    'start' => '/usr/spamtagger/etc/init.d/clamd start && /usr/spamtagger/etc/init.d/clamspamd start',
    'stop' => '/usr/spamtagger/etc/init.d/clamd stop && /usr/spamtagger/etc/init.d/clamspamd stop',
    'files' => {
