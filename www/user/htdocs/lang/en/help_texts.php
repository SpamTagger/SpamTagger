...
*<h6>A plug-in may be added to Microsoft Outlook for Windows to automatically notify SpamTagger that spam has been received.
*This plug-in installs a button in the menu bar that displays the SpamTagger logo and the caption "Unwanted".</h6>
...
*<h2>Download SpamTagger plug-in for Outlook</h2>
...
*<h2>Installing the SpamTagger plug-in for Outlook</h2>
*<p>To install the SpamTagger plug-in for Outlook for Windows:</p>
*<ul>
