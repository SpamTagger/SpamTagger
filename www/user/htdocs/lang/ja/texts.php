...
$txt['CONFSENDANALYSE'] = "A filter adjustment request will be sent to the SpamTagger Analysis Center; it includes a copy of the message that was wrongly blocked.</br>Note: A filter adjustment is not the same as wantlisting or blocklisting";
 ...
 * some error messages
 */
$txt['BADARGS'] = "Internal SpamTagger error (_PARAM_MESSAGE_ERREUR__). Please contact your system administrator with details of the problem.";
