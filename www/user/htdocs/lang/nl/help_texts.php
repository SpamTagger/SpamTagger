...
<p>Begrijp de principes en technieken gebruikt de SpamTagger.</p>
...
<h3>Configuratie</h3>
<p>Pas SpamTagger aan zodat het past voor je noden en gewoonten.</p>
...
<p>Voor elk, door SpamTagger, gefilterd adres, zijn je gebruikersnaam en paswoord dezelfde als deze die gebruikt worden voor je e-mail account in je standaard e-mail programma.</p>
...
of als een spam bericht verkeerdelijk in je mailbox geleverd wordt. In het eerste geval zal SpamTagger een regel versoepelen om toleranter te zijn naar een bepaalde zender of
 formaat. In het tweede geval wordt SpamTagger strikter.</p>
<h3>Wat gebeurt er wanneer ik een filter aanpassing vraag?</h3>
<p>Een kopie van het bericht werd naar het <em>SpamTagger Analysis Center</em> verzonden. Dat bericht wordt onderzocht door SpamTagger ingenieurs en de filter kan worden aangepast.</p>
...
<h3>Waarom plaatste SpamTagger een bericht in de quarantine, terwijl ik deze had moeten ontvangen?</h3>
...
Het betekent niet dat SpamTagger defect is, maar gewoonweg dat het systeem voorzichtig reageert wanneer het ongebruikelijke eigenschappen van een e-mail bericht tegenkomt en deze
...
<h3>Waarom liet SpamTagger spam in mijn mailbox komen?</h3>
...
Daarom is het zeer belangrijk dat je deze fout meldt aan het <em>SpamTagger Analysis Center</em>, die dan de gepaste filter regels zullen versterken.
In grensgevallen kiest SpamTagger om het bericht in je mailbox af te leveren, omdat het beter is om spam te ontvangen in uitzonderlijke gevallen, dan een mogelijk belangrijk bericht te missen.</p>
<h2>Virussen en gevaarlijke berichten</h2>
<h3>Hoe gaat SpamTagger om met virussen?</h3>
...
of liken naar verdachte websites. SpamTagger verwijdert gevaarlijke inhoud en levert de rest van het bericht naar je mailbox, samen met een uitleg hoe je de administrators
...
<h3>Authenticatie</h3>
<p>Een proces dat de echte identiteit van een persoon vergelijkt met de identiteit die deze persoon beweert te hebben. Succesvolle authenticatie in SpamTagger is noodzakelijk voor een gebruiker voor zijn/haar quarantaine toegang.</p>
<h3>Analyse Center</h3>
<p>Een team van gespecialiseerde ingenieurs, die op het SpamTagger hoofdkwartier werken, garanderen dat de hoogste kwaliteit van filteren behaald wordt, tegen het wereldwijde spam verkeer, virus activiteit en door het aanpassen van aanvragen door SpamTagger gebruikers wereldwijd.</p>
...
<p>Alle Internet-domeinen behandeld door dezelfde instantie van SpamTagger (voorbeelden: company.com, enterprise.com).</p>
<h3>Vals negatief</h3>
<p>Spam dat niet als dusdaning geïdentificeerd werd door de SpamTagger filter. Alle valse negatieven moeten gemeld worden aan het Analysis Center om de gepaste actie te ondernemen.</p>
<h3>Vals postief</h3>
...
<p>Een privé Internet zone waar je binnenkomende, in quarantaine geplaatste, berichten kan onderzoeken en verzschillende SpamTagger opties kan configureren.</p>
<h3>Plug-in</h3>
<p>Een extensie die kan toegeveogd worden aan een reeds bestaande software toepassing. De SpamTagger plug-in voor Microsoft Outlook vereenvoudigt het proces van valse negatieve te melden.</p>
<h3>Quarantine</h3>
...
<h3>Zwitserland</h3>
<p>Land van oorsprong van SpamTagger, waar spam uitgeroeid word met de precisie en kwaliteit van een horlogemaker.</p>
<h3>Virus</h3>
<p>Een ongewenste software entiteit, soms als bijlage, dat de integriteit van je pc kan veranderen.</p>
<h3>Waarschuw lijst</h3>
<p>Een lijst met e-mail adressen die betrouwbaar zijn en normaal gezien geen spam zouden mogen genereren. Je zal een waarschuwing krijgen van SpamTagger wanneer een bericht, verzonden van een waarschuw lijst adres, geblokkeerd wordt.</p>
<h3>Witte lijst</h3>
<p>Een lijst van e-mail adressen die volledig betrouwbaar zijn. Berichten verzonden van witte lijst adressen zullen nooit geblokkeerd worden door SpamTagger.</p>
<h3>Wauw.</h3>
<p>Wat we hopen dat jullie zullen zeggen als een SpamTagger gebruiker.</p>
';
...
<h6>Als je Outlook met de __LINKHELP_plugin__SpamTagger extension__LINK__ niet gebruikt, zullen alle filter aanpassing aanvragen, die komen vanwege ongewenste spam, manueel verzonden worden naar een specifiek e-mail adres naar het <em>SpamTagger Analysis Center</em>.</h6>
