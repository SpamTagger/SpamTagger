...
$htxt['MANUAL_FIRSTCONTACT_NAME'] = 'spamtagger_guia_rapida.pdf';
$htxt['MANUAL_GENERICCONCEPT_NAME'] = 'spamtagger_principios_generales.pdf';
$htxt['MANUAL_GUI_NAME'] = 'spamtagger_espacio_de_gestion.pdf';
$htxt['MANUAL_QUARANTINE_NAME'] = 'spamtagger_parte_cuarentena.pdf';
$htxt['MANUAL_STATS_NAME'] = 'spamtagger_parte_estaditicas.pdf';
$htxt['MANUAL_CONFIGURATION_NAME'] = 'spamtagger_parte_configuracion.pdf';
$htxt['MANUAL_ERRORS_NAME'] = 'spamtagger_imprecisiones_de_filtracion.pdf';
...
<p>Entender las estrategias de prevenci&oacute;n y de defensa que utiliza SpamTagger.</p>
...
<p>Para personalizar SpamTagger seg&uacute;n sus costumbres y sus necesidades.</p>
...
<p>Es una acci&oacute;n que realiza despu&eacute;s del bloqueo de un mensaje leg&iacute;timo en la cuarentena o de la llegada de un spam en su buz&oacute;n. En el primer caso, el ajuste del filtro permite a SpamTagger ser m&aacute;s tolerante con un remitente en particular. En el segundo caso, el filtro de SpamTagger ser&aacute; m&aacute;s agresivo.</p>
<h3>&iquest;Qu&eacute; pasa durante una solicitud de ajuste del filtro?</h3>
<p>El <em>centro de an&aacute;lisis de SpamTagger</em> recibe una copia del mensaje. Despues de un examen, es posible que los ingenieros corrijan el filtro.
...
<h3>&iquest;Por qu&eacute; SpamTagger bloquea un mensaje que habr&iacute;a debido recibir?</h3>
<p>Porque este mensaje tiene or&iacute;genes dudosas (quiz&aacute;s sirve de relevo de spam por los piratas) y/o comporta un formato espec&iacute;fico que activa una regla de spam. Entonces no trata de un error de SpamTagger pero el filtro act&uacute;a de manera prudente frente a caracter&iacute;sticas espec&iacute;ficas de un mensaje, que pueden ser invisibles con una lectura simple del contenido.</p>
...
<h3>&iquest;Por qu&eacute; SpamTagger deja pasar spams?</h3>
<p>Algunos escapan a los controles de SpamTagger porque est&aacute;n muy pr&oacute;ximos de mensajes leg&iacute;timos. Es por esta raz&oacute;n que tiene que declarar este error al centro de an&aacute;lisis para intensificar algunas reglas. Sin olvidar que si tiene dudas, SpamTagger le env&iacute;a el mensaje porque estima que es menos grave recibir un spam que ser privado de un mensaje leg&iacute;timo.</p>
<h2>Virus et mensajes peligrosos</h2>
<h3>&iquest;C&oacute;mo SpamTagger trata los virus?</h3>
<p>SpamTagger suprime los virus. No recibe notificaci&oacute;n.</p>
...
<p>Equipo de ingenieros especializados que trabajan en la sede del editor de SpamTagger, que garantiza en permanencia una alta calidad de filtraci&oacute;n, en funci&oacute;n del tr&aacute;fico mundial de los spams, de la actividad de los virus y de las solicitudes de ajuste efectuadas por les usuarios en el mundo entero.</p>
<h3>Complemento (plug-in)</h3>
<p>M&aacute;s conocido en ingl&eacute;s. Tiene que instalar el complemento es decir el plug-in en una aplicaci&oacute;n. El complemento SpamTagger para Microsolft Outlook simplifica la notificaci&oacute;n de los falsos-negativos.</p>
...
<p>Conjunto de los dominios de Internet examinados por el mismo dispositivo SpamTagger (ejemplos: @martinez.com, @rodriguez.com).</p>
<h3>Espacio de gesti&oacute;n</h3>
...
<p>Mensaje que no fue analizado como un spam por SpamTagger. Tiene que notificar cada falso-negativo al centro de an&aacute;lisis para que el filtro pueda considerar esta excepci&oacute;n en el futuro.</p>
<h3>Falso-positivo</h3>
<p>Mensaje leg&iacute;timo que SpamTagger considera como un spam. Cada falso-positivo necesita una solicitud de ajuste del filtro.</p>
<h3>Fastnet SA</h3>
<p>Editor de SpamTagger. Es lo contrario de los spams. Su sede est&aacute; en St-Sulpice, en Suiza.</p>
<h3>Identificaci&oacute;n</h3>
<p>Proceso que sirve para verificar la identidad de una persona. En SpamTagger, con una buena identificaci&oacute;n, puede acceder a su cuarentena.</p>
...
<p>Acci&oacute;n voluntaria consecutiva a un bloqueo de un mensaje leg&iacute;timo en la cuarentena o a la llegada de un spam en su buz&oacute;n.  En el primer caso, el ajuste del filtro permite a SpamTagger ser m&aacute;s tolerante con un remitente en particular. En el segundo caso, SpamTagger ser&aacute; m&aacute;s agresivo. Es el centro de an&aacute;lisis de SpamTagger que trata las solicitudes.</p>
<h3>Suiza</h3>
<p>Pa&iacute;s de origen de SpamTagger. Elimina los spams con una calidad y una precisi&oacute;n extrema.</p>
<h3>Virus</h3>
...
<h6>Si no utiliza Microsoft Outlook con el complemento __LINKHELP_plugin__SpamTagger extension__LINK__, tiene que redactar manualmente un correo al centro de an&aacute;lisis de SpamTagger si un spam no fue filtrado.</h6>
...
<h2>&iquest;C&oacute;mo se&ntilde;alar un spam que escap&oacute; al control de SpamTagger? (falso-negativo)</h2>
...
<ul>
 ...
 <li>Indique como destinatario la direcci&oacute;n del centro de an&aacute;lisis de SpamTagger escrita previamente.</li>
