...
class Default_Model_ReportingStats {
  ...
  public function createPieChart($id = null, $data = null, $params = array()) {
    ...
    $picture->setFontProperties(array("FontName"=>"/usr/spamtagger/www/admin/application/library/pChart/fonts/GeosansLight.ttf","FontSize"=>6,"R"=>80,"G"=>80,"B"=>80));
    ...
    if (isset($params['render']) && $params['render']) {
      ...
      $file = '/usr/spamtagger/www/admin/public/tmp/'.$id.".png";
      $picture->render($file);
      return $id;
    }
  }
