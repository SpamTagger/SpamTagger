...
$services_ = array(
  ...
  'SOURCEDB' => array('restartfile' => "mariadb_source.rn", 'starter' => "S_mariadb_source.sh", 'stopper' => "H_mariadb_source.sh", 'restarter' => "R_mariadb_source.sh"),
  'REPLICADB' => array('restartfile' => "mariadb_replica.rn", 'starter' => "S_mariadb_replica.sh", 'stopper' => "H_mariadb_replica.sh", 'restarter' => "R_mariadb_replica.sh"),
